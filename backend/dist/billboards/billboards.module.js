...
const billboards_controller_1 = require("./billboards.controller");
...
exports.BillboardsModule = BillboardsModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [billboards_controller_1.BillboardsController],
        providers: [billboards_service_1.BillboardsService],
    })
], BillboardsModule);
